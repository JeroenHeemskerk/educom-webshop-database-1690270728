...
function showChangePassword($data) {
    echo '  <div class="content">
                ...
                <form action="index.php" method="POST">
                    ...
                    <br>
                    <input type="text" name="current_password" value="' . getValue($data, "current_password") . '">
                    ' . getError($data, "current_password") . '
                    <br>
                    <label for="new_password">New password</label>
                    <br>
                    <input type="text" name="new_password" value="' . getValue($data, "new_password") . '">
                    ' . getError($data, "new_password") . '
                    <br>
                    <label for="confirm_new_password">Confirm new password</label>
                    <br>
                    <input type="text" name="confirm_new_password" value="' . getValue($data, "confirm_new_password") . '">
